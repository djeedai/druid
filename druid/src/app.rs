...
use crate::{AppDelegate, Data, Env, LocalizedString, Menu, Widget, WidgetId};
...
/// which needs its own, instead of using the top-level one.
/// Only used for integration of platform-dependent external features.
#[derive(Clone)]
